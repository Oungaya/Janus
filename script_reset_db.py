...
def main():  
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Compétences en Ingénierie des SI\', \'1\', \'1\', \'1\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Domaine d''application\', \'1\', \'4\', \'1\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Professionnalisation\', \'1\', \'6\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Compétences en Ingénierie des SI\', \'2\', \'1\', \'1\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Domaine d''application\', \'2\', \'4\', \'1\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M1 MIAGE Professionnalisation\', \'2\', \'6\', \'0\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 OSIE Compétences en Informatique\', \'3\', \'2\', \'1\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 OSIE Compétences en Gestion\', \'3\', \'3\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 OSIE Compétences Transverses\', \'3\', \'5\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 OSIE Professionnalisation\', \'3\', \'6\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SID Compétences en Ingénierie des SI\', \'4\', \'1\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SID Compétences en Informatique\', \'4\', \'2\', \'1\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SID Compétences en Gestion\', \'4\', \'3\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SID Compétences Transverses\', \'4\', \'5\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SID Professionnalisation\', \'4\', \'6\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIO Compétences en Ingénierie des SI\', \'5\', \'1\', \'1\');\
    ...
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIO Compétences en Gestion\', \'5\', \'3\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIO Compétences Transverses\', \'5\', \'5\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIO Professionnalisation\', \'5\', \'6\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIS Compétences en Ingénierie des SI\', \'6\', \'1\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIS Compétences en Informatique\', \'6\', \'2\', \'1\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIS Compétences Transverses\', \'6\', \'5\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIS eSanté\', \'6\', \'7\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 SIS Professionnalisation\', \'6\', \'6\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 INE Compétence en Ingénierie des SI\', \'7\', \'1\', \'0\');\
    INSERT INTO optionnelles_pole(nom, parcours_id, typePole_id, a_choisir_dans_pole) VALUES (\'M2 INE Professionnalisation\', \'7\', \'6\', \'3\');\
