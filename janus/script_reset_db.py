...
def main():  
    ...
    INSERT INTO optionnelles_ue(nom, num_UE, code_apoge, nombre_groupes, nombre_heures_CM, nombre_heures_TD, semestre_id) VALUES (\'Etude de cas création d entreprise\', \'PRO_02\', \'0\', \'0\', \'0\', \'0\', \'3\');\
